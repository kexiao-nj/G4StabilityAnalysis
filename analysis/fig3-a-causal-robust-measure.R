...
calc_acc_covr <- function(sla_fun='pc.stable', test_fun='mc-x2', step=50, suffix='bs1-9', tardir='robusttest', M=0.1, N=10){
  prefix <- 'matrix'
...
for (proportion in seq(0.1,0.5,0.1)){
  print("##############################################################")
...
mean_std_df <- calc_mean_std(sla_fun='pc.stable', test_fun='mc-x2', step=50, suffix='bs1-9', tardir='robusttest', N=10)
